...
-- INSERT INTO informatie (naam, diameter, `afstand tot de zon`, `massa tot de aarde`) VALUES ('Venus', 12104, 108208930, 0.9);
-- INSERT INTO informatie (naam, diameter, `afstand tot de zon`, `massa tot de aarde`) VALUES ('Jupiter', 142.984, 778412010, 318);
-- INSERT INTO informatie (naam, diameter, `afstand tot de zon`, `massa tot de aarde`) VALUES ('Uranus', 51118, 287097220, 15);
